...
<svg xmlns="http://www.w3.org/2000/svg" style="display:none">
  <!-- نمط موحّد: stroke="currentColor" و stroke-width="2" وزوايا دائرية -->
  ...
  <symbol id="i-globe" viewBox="0 0 24 24">
    ...
    <path d="M3 12h18M12 3a16 16 0 0 1 0 18M12 3a16 16 0 0 0 0 18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
  </symbol>
  ...
  <symbol id="i-dashboard" viewBox="0 0 24 24">
    <rect x="3" y="3" width="9" height="7" rx="2" fill="none" stroke="currentColor" stroke-width="2"/>
    <rect x="13" y="14" width="8" height="7" rx="2" fill="none" stroke="currentColor" stroke-width="2"/>
    <path d="M4.5 9l2.5-2.5 2 1.7 2-2" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
  </symbol>
  ...
  <symbol id="i-users" viewBox="0 0 24 24">
    ...
    <path d="M3 20v-1.5A4.5 4.5 0 0 1 7.5 14h3A4.5 4.5 0 0 1 15 18.5V20" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
  ...
  <symbol id="i-sun" viewBox="0 0 24 24">
    ...
    <path d="M12 2v2M12 20v2M4 12H2M22 12h-2M5.5 5.5l1.4 1.4M17.1 17.1l1.4 1.4M5.5 18.5l1.4-1.4M17.1 6.9l1.4-1.4" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
  </symbol>

  <symbol id="i-moon" viewBox="0 0 24 24">
    <path d="M21 12.5A8.5 8.5 0 1 1 11.5 3a6.7 6.7 0 0 0 9.5 9.5Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>
  </symbol>

  <!-- الإعدادات -->
  <symbol id="i-settings" viewBox="0 0 24 24">
    <circle cx="12" cy="12" r="3" fill="none" stroke="currentColor" stroke-width="2"/>
    <path d="M19.4 12a7.4 7.4 0 0 0-.1-1l2-1.5-2-3.5-2.5 1a7.6 7.6 0 0 0-1.6-1l-.4-2.7H11l-.4 2.7a7.6 7.6 0 0 0-1.6 1l-2.5-1-2 3.5L6.5 11a7.4 7.4 0 0 0 0 2l-2 1.5 2 3.5 2.5-1a7.6 7.6 0 0 0 1.6 1l.4 2.7h3.8l.4-2.7a7.6 7.6 0 0 0 1.6-1l2.5 1 2-3.5-2-1.5c.07-.33.1-.67.1-1Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>
  </symbol>
