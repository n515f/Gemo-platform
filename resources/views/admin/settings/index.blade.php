  ...
  <div class="cards-grid">
            ...
            <div class="field col-span-2">
              ...
              @if($site->ceo_image_path)
                <div style="margin-top:8px">
                  <img src="{{ asset($site->ceo_image_path) }}" alt="{{ __('app.ceo_image_alt') }}" style="max-width:160px;border-radius:10px">
                </div>
              @endif
            </div>
          </div>
    ...
    <div class="settings-card" data-settings-card data-open="0" tabindex="0" aria-expanded="false" role="button">
      ...
      <div class="card-body">
        <form class="card-form" data-card-form action="{{ route('admin.settings.updateAll') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <p class="card-desc">{{ __('app.ceo_certificates_help') }}</p>
          ...
          <div id="cert-list" class="kv-list">
            ...
            @empty
              ...
              <div class="kv-row">
                <div class="kv-key">
                  <span class="key-label">{{ __('app.certificate_no') }}1</span>
                </div>
                <div class="kv-value">
                  <div class="form-grid">
                    <div class="field">
